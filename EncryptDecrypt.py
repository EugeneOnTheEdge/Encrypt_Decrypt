...
def main():
     mode = raw_input('Mode: "e" for encrypt, "d" for decrypt > ')[0]
     if mode == 'e':
          end = 'ENCRYPTED'
     elif mode == 'd':
          end = 'DECRYPTED'
     toProcess = raw_input(('Enter the sentence to be '+end+' > '))
     pwd = getpass.win_getpass('Enter password > ')
